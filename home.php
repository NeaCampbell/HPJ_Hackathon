                    ...
                    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="https://api.whatsapp.com/send/?phone=6281556727404&text&type=phone_number&app_absent=0">
                                    <img src="assets/iklan_1.jpg" class="d-block w-100" alt="...">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a href="membership.php">
                                    <img src="assets/iklan_2.jpg" class="d-block w-100" alt="...">
                                </a>
                            </div>
                            <div class="carousel-item">
                                <a href="https://api.whatsapp.com/send/?phone=6281556727404&text&type=phone_number&app_absent=0">
                                    <img src="assets/iklan_3.jpg" class="d-block w-100" alt="...">
                                </a>
                            </div>
                        </div>
